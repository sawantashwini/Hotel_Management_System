...
/**
 * Servlet implementation class ReciepeRelationServlet
 */
@WebServlet("/ReciepeRelationServlet")
public class ReciepeRelationServlet extends HttpServlet {
