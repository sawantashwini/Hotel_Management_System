...
<body>
	...
	<%@include file="include/breadcrumbs.jsp"%>
		...
		<div class="pagetitle text-center">
			<h1 id="page_title">Liquor Purchase Item Report</h1>
		</div>
				...
				<div class="card table-responsive">
					<div class="card-body">
						...
						<div class="row " id="table_search">
							...
							<form class="row g-3 d-flex justify-content-center" autocomplete="off">
								<%
								...
								<div class="col-lg-2 col-md-3 col-6">
									<div class="control form-floating ">
										...
										<datalist id="browsers">
											...
											ArrayList<MenuItemDto> i_list = ser.getActiveMenuLiquorItemInfo(config, request);
											for (MenuItemDto i_dto : i_list) {
											%>
						...
						<table id="examples-small" class="table hover"
							...
							<tbody class="text-center" id="tbody">
								<%
								LiquorPurchaseBillService ser1 = new LiquorPurchaseBillService();
								ArrayList<LiquorPurchaseBillDto> list1 = ser1.getPurchaseBillItemInfo(d1, d2, search_item, config, request);
