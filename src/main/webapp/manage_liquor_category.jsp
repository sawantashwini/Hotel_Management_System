...
<body>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle text-center">
			...
			<h1 id="page_title">Liquor Brand Stock</h1>
		</div>
...
<%-- 
							...
							<tbody class="text-center" id="tbody">
								...
								ArrayList<LiquorCategoryDto> list1 = ser.getLiquorCategoryInfo(config, request);
								...
								<tr>
									...
									<td><%=dto.getQuantity()/dto.getCapacity()%></td>
									<td><%=dto.getMin_qty()%></td>
									<td><%=dto.getCapacity()%></td>

									<%if(user_head_dto.getUpdate_module().equalsIgnoreCase("Yes")){ %>
									<td><a href="edit_liquor_category.jsp?id=<%=dto.getId()%>"><i
