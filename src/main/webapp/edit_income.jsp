				...
				<div class="col-lg-12">
					...
					<div class="card" style="border-radius: 25px;">
						...
						<div class="card-body">
							...
							IncomeDto dto = service.getIncomeInfoById(id, config, request);
							%>
							...
							<form action="IncomeServlet" enctype="multipart/form-data"
								...
								<div class="col-md-3">
									<div class="control form-floating">
										<input type="hidden" id="user_id_fk" name="User_id_fk"
											...
											id="income_id" name="Id" value="<%=id%>"> <input
											type="Date" class="form-control" id="in_date" name="In_date"
											value="<%=dto.getIn_date()%>" placeholder="in_date" required>
								...
								<div class="col-md-4 refresh-container mb-3"
									data-add="add_liquor_item.jsp" data-list="list_income_head">
									<div class="control form-floating refresh-input">
										<input type="text" class="form-control"  id="name" name="Name"
											placeholder="Name" autocomplete="off" required> <input
											type="hidden" id="head_id_fk" name="Head_id_fk"
											value="<%=dto.getHead_id_fk()%>"> <label for="name">Income
											Head</label>
										<div class="invalid-feedback">Please, enter Income Head!</div>
									</div>
								</div>
												...
												<div class="d-flex justify-content-center">
													...
													<div class="pt-1 pb-1" style="margin-left: 2px;">
														<a class="btn btn-primary btn-sm" title="download"
															href="IncomeImage/<%=dto.getId()%>.jpg" id="download"
