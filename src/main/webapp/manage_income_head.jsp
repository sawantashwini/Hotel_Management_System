...
<body>
	...
	<main id="main" class="main">
		...
		<%@include file="include/add_pages.jsp"%>
			<h1 id="page_title">Manage Income Head</h1>
		</div>
					...
					<div class="card-body table-responsive">
						...
						<table id="example-small"
							...
							<tbody class="text-center" id="tbody">
								...
								ArrayList<IncomeHeadDto> list1 = ser.getIncomeHeadInfo(config, request);
								for (IncomeHeadDto dto : list1) {
								%>
								<tr>
									...
									<td><a class="main-color"
										href="edit_income_head.jsp?id=<%=dto.getId()%>"><i
											class="bi bi-pencil-square"></i></a></td>
									<%-- <td><a onclick="return confirm('Are you sure? You want to delete')" href="AjaxDelete.jsp?income_head_id=<%=dto.getId()%>">
