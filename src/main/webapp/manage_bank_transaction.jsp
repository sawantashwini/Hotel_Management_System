...
<body>
	...
	<main id="main" class="main">
		...
		<%@include file="include/add_pages.jsp"%>
			<h1 id="page_title">Bank To Bank Transaction Report</h1>
		</div>
						...
						<table id="examples" class="table hover table-responsive nowrap">
							<thead class="text-center" id="thead">
								<tr>
									...
									<th style="width: 10%; text-align: center;">From Bank</th>
									<th style="width: 10%; text-align: center;">To Bank</th>
							...
							<tbody class="text-center" id="tbody">
								...
								ArrayList<BankDto> list1 = ser.getTransactionInfo(config, request);
								...
								<tr>
									...
									<td><%=dto.getDebit_bank_name()%></td>
									<td><%=dto.getTransaction_amount()%></td>
									<td><%=dto.getRemark()%></td>
									<td class="main-color"><%=dto.getStatus()%></td>

									<td><a href="edit_bank_transaction.jsp?id=<%=dto.getId()%>"><i
											class="bi bi-pencil-square"></i></a></td>

									<td><a
										onclick="return confirm('Are you sure? You want to delete')"
										href="AjaxBankDelete.jsp?id=<%=dto.getId()%>&debit_online_id_fk=<%=dto.getDebit_online_id_fk()%>&credit_online_id_fk=<%=dto.getCredit_online_id_fk()%>&type=Bank_Transaction"> <i
