...
<html>
<head>
<title>Customer due receipt</title>
<style>
a {
...
<button class="print-button" id="print-button" onclick="printBill()">Print</button>
		<a class="home-button" id="home-button" href="manage_customer.jsp">Home</a>
<br>
<br>
		<%
		...
		<%
			...
			CustomerDueService service = new CustomerDueService();
			CustomerDto dto = service.getCustomerDueInfoByPaidId(id, config, request);
			String igst_status = "";
