...
<body>
	...
	<%@include file="include/breadcrumbs.jsp"%>
		...
		<%@include file="include/add_pages.jsp"%>
			<h1 id="page_title"> Ingredients Stock</h1>
		</div>
					...
					<div class="card-body table-responsive">
						...
						<table id="examples-small" class="table hover table-responsive nowrap">
							...
							<tbody class="text-center" id="tbody">
								...
								ArrayList<IngredientsDto> list1 = ser.getIngredientsItemInfo(config, request);
								for (IngredientsDto dto : list1) {
								%>
								<tr>
									<td><%=list1.indexOf(dto) + 1%></td>
									<td><%=dto.getName()%></td>
									<td class="main-color"><%=dto.getQty()%> (<%=dto.getMeasurement_name()== null ? "N/A": dto.getMeasurement_name()%>)</td>
