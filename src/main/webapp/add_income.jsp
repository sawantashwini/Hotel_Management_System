								...
								<div class="col-md-3">
									<div class="control form-floating">
										...
										<input type="Date" class="form-control" id="in_date"
											name="In_date" placeholder="Date" value="<%=current_date%>"
											required> <label for="in_date">Date</label>
										<div class="invalid-feedback">Please, enter Date!</div>
									</div>
								</div>

								<div class="col-md-4 d-flex refresh-container mb-3"
									data-add="add_income_head.jsp" data-list="list_income_head">
									<div class="control form-floating refresh-input">
										<input type="text" class="form-control" id="name" name="Name"
											placeholder="Name" autocomplete="off" required>
											<input type="hidden" id="head_id_fk" name="Head_id_fk"> <label
											for="name">Income Head</label>
