...
<body onload="myResultLoadEvent()">
	...
	<main id="main" class="main" style="margin-left: 0px;">
		...
		<div class="pagetitle text-center">
			<h1 id=page_title>Pending  Bill</h1>
		</div>
								...
								<div class="col-md-2 col-4">
									<div class="form-floating control">
										<input type="datetime-local" class="form-control " id="d2" name="D2"
											value="<%=d2%>"> <label for="floatingPhone">To Date</label>
									</div>
								</div>
						...
						<table id="examples-small" class="table hover" style="min-width: 100%;">
							...
							<thead id="thead">
								<tr>
									...
									<th style="text-align: center;" width="2%">Billing</th>
							...
							<tbody id="tbody" class="text-center">
								...
								ArrayList<OrderBillDto> list = service.getAllOrderInfo(d1, d2 , "pending",  config, request);
								...
								<tr>
									...
									<td><a class="main-color"
										href="order_bill.jsp?order_id=<%=dto.getId()%>"><i
