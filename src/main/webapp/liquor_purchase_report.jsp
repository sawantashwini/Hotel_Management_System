...
<body>
	...
	<main id="main" class="main">
		...
		<%@include file="include/add_pages.jsp"%>
			<h1 id="page_title">Liquor Purchase Report</h1>
		</div>
						...
						<table id="examples-small" class="table hover nowrap">
							<thead class="text-center" id="thead">
								<tr>
									...
									<th style="text-align: center;" width="15%">Dealer name</th>
							...
							<tbody class="text-center" id="tbody">
								...
								ArrayList<LiquorPurchaseBillDto> list1 = ser.getPurchaseBillInfo(d1, d2, config, request);
								...
								<tr>
									...
									<td><a href="print_liquor_purchase_bill.jsp?id=<%=dto.getId()%>"><i
