...
<body>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle text-center">
			...
			<h1 id="page_title">Ingredients In Report</h1>
		</div>
					...
					<div class="card-body">
						...
						<table id="example-small" class="table hover nowrap">
							...
							<tbody class="text-center" id="tbody">
								...
								ArrayList<IngredientsDto> list1 = ser.getIngredientsPurchaseBillInfo(d1, d2, config, request);
								...
								<tr>
									...
									<td><a
										href="print_ingredients_purchase.jsp?id=<%=dto.getId()%>"><i
											class="bi bi-printer"></i></a></td>
									<%
									if (user_head_dto.getUpdate_module().equals("Yes")) {
									%>
									<td><a
										href="edit_ingredients_purchase.jsp?id=<%=dto.getId()%>"><i
									...
									<td><a
										...
										href="AjaxFolder/AjaxDelete.jsp?id=<%=dto.getId()%>&type=Ingredients_Purchase">
